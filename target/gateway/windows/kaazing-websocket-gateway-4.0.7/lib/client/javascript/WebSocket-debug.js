...
var _72d=_71f.parent.parent._webSocket.connectTimeout;
if(_72d==0){
_72d=5000;
}
...
if(_724.status==201){
var _72e=_724.responseText.split("\n");
var _72f=_72e[0];
var _730=_72e[1];
var _731=new URI(_724.xhr._location);
var _732=new URI(_72f);
var _733=new URI(_730);
if(_731.host.toLowerCase()!=_732.host.toLowerCase()){
throw new Error("Hostname in original URI does not match with the hostname in the upstream URI.");
}
if(_731.host.toLowerCase()!=_733.host.toLowerCase()){
throw new Error("Hostname in original URI does not match with the hostname in the downstream URI.");
}
_71f._upstream=_731.scheme+"://"+_731.authority+_732.path;
_71f._downstream=new _6b1(_730);
var _734=_730.substring(0,_730.indexOf("/;e/"));
if(_734!=_71f.parent._location.toString().replace("ws","http")){
_71f.parent._redirectUri=_734;
}
_735(_71f,_71f._downstream);
...
var _736=function(_737){
_6f4.entering(this,"WebSocketEmulatedProxy.doOpen");
_737.readyState=1;
var _738=_737.parent;
_738._acceptedProtocol=_738.responseHeaders["X-WebSocket-Protocol"]||"";
if(_737.useXDR){
this.upstreamXHR=null;
openUpstream(_737);
}
_737._listener.connectionOpened(_737.parent,_738._acceptedProtocol);
};
function doError(_739){
if(_739.readyState<2){
...
if(_739.onerror!=null){
_739._listener.connectionFailed(_739.parent);
}
}
};
var _713=function(_73a,_73b,code,_73d){
...
case 0:
case 1:
_73a.readyState=WebSocket.CLOSED;
if(_73a.idleTimer){
clearTimeout(_73a.idleTimer);
}
if(_73a.upstreamXHR!=null){
_73a.upstreamXHR.abort();
}
if(typeof _73b==="undefined"){
_73a._listener.connectionClosed(_73a.parent,true,1005,"");
}else{
_73a._listener.connectionClosed(_73a.parent,_73b,code,_73d);
}
break;
default:
}
};
var _719=function(_73e){
};
var _73f=function(_740,_741){
_6f4.finest("WebSocket.handleMessage: A WebSocket frame received on a WebSocket");
if(_741.text){
_740._listener.textMessageReceived(_740.parent,_741.text);
}else{
if(_741.data){
_740._listener.binaryMessageReceived(_740.parent,_741.data);
}
}
};
var _742=function(_743){
var _744=ByteBuffer.allocate(2);
_744.put(_700);
_744.put(0);
_744.flip();
doSend(_743,_744);
};
var _735=function(_745,_746){
_6f4.entering(this,"WebSocketEmulatedProxy.bindHandlers");
_746.onmessage=function(_747){
switch(_747.type){
case "message":
if(_745.readyState==1){
_73f(_745,_747);
}
break;
}
};
_746.onping=function(){
if(_745.readyState==1){
_742(_745);
}
};
_746.onerror=function(){
try{
_746.disconnect();
}
finally{
_713(_745,true,_745.closeCode,_745.closeReason);
}
};
_746.onclose=function(_748){
try{
_746.disconnect();
}
finally{
_713(_745,true,this.closeCode,this.closeReason);
}
};
};
return _6f5;
...
var _749=(function(){
var _74a="WebSocketEmulatedDelegateHandler";
var LOG=_26b.getLogger(_74a);
var _74c=function(){
LOG.finest(_74a,"<init>");
};
var _74d=_74c.prototype=new _52d();
_74d.processConnect=function(_74e,uri,_750){
LOG.finest(_74a,"connect",_74e);
if(_74e.readyState==WebSocket.CLOSED){
throw new Error("WebSocket is already closed");
}
var _751=!!window.MockWseTransport?new MockWseTransport():new _6f3();
_751.parent=_74e;
_74e._delegate=_751;
_752(_751,this);
_751.connect(uri.toString(),_750);
};
_74d.processTextMessage=function(_753,text){
LOG.finest(_74a,"connect",_753);
if(_753.readyState==WebSocket.OPEN){
_753._delegate.send(text);
}else{
throw new Error("WebSocket is already closed");
}
};
_74d.processBinaryMessage=function(_755,obj){
LOG.finest(_74a,"processBinaryMessage",_755);
if(_755.readyState==WebSocket.OPEN){
_755._delegate.send(obj);
}else{
throw new Error("WebSocket is already closed");
}
};
_74d.processClose=function(_757,code,_759){
LOG.finest(_74a,"close",_757);
try{
_757._delegate.close(code,_759);
}
catch(e){
listener.connectionClosed(_757);
}
};
var _752=function(_75a,_75b){
var _75c=new _540(_75b);
_75a.setListener(_75c);
};
return _74c;
})();
var _75d=(function(){
var _75e="WebSocketEmulatedAuthenticationHandler";
var LOG=_26b.getLogger(_75e);
var _760=function(){
LOG.finest(_75e,"<init>");
};
var _761=_760.prototype=new _52d();
_761.handleClearAuthenticationData=function(_762){
if(_762._challengeResponse!=null){
_762._challengeResponse.clearCredentials();
}
};
_761.handleRemoveAuthenticationData=function(_763){
this.handleClearAuthenticationData(_763);
_763._challengeResponse=new ChallengeResponse(null,null);
};
_761.handle401=function(_764,_765,_766){
var _767=this;
var _768=null;
if(typeof (_764.parent.connectTimer)!="undefined"){
_768=_764.parent.connectTimer;
if(_768!=null){
_768.pause();
}
}
if(_556.KAAZING_SEC_EXTENSION_REVALIDATE==_766){
var _769=new _5af(_764);
_764.challengeHandler=_764.parent.challengeHandler;
_769.connect(_765);
}else{
var _76a=_765;
if(_76a.indexOf("/;e/")>0){
_76a=_76a.substring(0,_76a.indexOf("/;e/"));
}
var _76b=new _4ff(_76a.replace("http","ws"));
var _76c=new ChallengeRequest(_76a,_766);
var _76d;
if(_764._challengeResponse.nextChallengeHandler!=null){
_76d=_764._challengeResponse.nextChallengeHandler;
}else{
_76d=_764.parent.challengeHandler;
}
if(_76d!=null&&_76d.canHandle(_76c)){
_76d.handle(_76c,function(_76e){
try{
if(_76e==null||_76e.credentials==null){
_767.handleClearAuthenticationData(_764);
_767._listener.connectionFailed(_764);
}else{
if(_768!=null){
_768.resume();
}
_764._challengeResponse=_76e;
_767.processConnect(_764,_76b,_764._protocol);
}
}
catch(e){
_767.handleClearAuthenticationData(_764);
...
this.handleClearAuthenticationData(_764);
this._listener.connectionFailed(_764);
}
}
};
_761.processConnect=function(_76f,_770,_771){
if(_76f._challengeResponse!=null&&_76f._challengeResponse.credentials!=null){
var _772=_76f._challengeResponse.credentials.toString();
for(var i=_76f.requestHeaders.length-1;i>=0;i--){
if(_76f.requestHeaders[i].label==="Authorization"){
_76f.requestHeaders.splice(i,1);
}
}
var _774=new _4f1("Authorization",_772);
for(var i=_76f.requestHeaders.length-1;i>=0;i--){
if(_76f.requestHeaders[i].label==="Authorization"){
_76f.requestHeaders.splice(i,1);
}
}
_76f.requestHeaders.push(_774);
this.handleClearAuthenticationData(_76f);
}
this._nextHandler.processConnect(_76f,_770,_771);
};
_761.handleAuthenticate=function(_775,_776,_777){
_775.authenticationReceived=true;
this.handle401(_775,_776,_777);
};
_761.setNextHandler=function(_778){
this._nextHandler=_778;
var _779=new _540(this);
var _77a=this;
_779.authenticationRequested=function(_77b,_77c,_77d){
_77a.handleAuthenticate(_77b,_77c,_77d);
};
_778.setListener(_779);
};
_761.setListener=function(_77e){
this._listener=_77e;
};
return _760;
})();
var _77f=(function(){
var _780="WebSocketEmulatedHandler";
var LOG=_26b.getLogger(_780);
var _782=new _75d();
var _783=new _570();
var _784=new _749();
var _785=function(){
LOG.finest(_780,"<init>");
this.setNextHandler(_782);
_782.setNextHandler(_783);
_783.setNextHandler(_784);
};
var _786=_785.prototype=new _52d();
_786.processConnect=function(_787,_788,_789){
var _78a=[];
for(var i=0;i<_789.length;i++){
_78a.push(_789[i]);
}
var _78c=_787._extensions;
if(_78c.length>0){
_787.requestHeaders.push(new _4f1(_556.HEADER_SEC_EXTENSIONS,_78c.join(";")));
}
...
var _793=(function(){
var _794="WebSocketFlashEmulatedDelegateHandler";
var LOG=_26b.getLogger(_794);
var _796=function(){
LOG.finest(_794,"<init>");
};
var _797=_796.prototype=new _52d();
_797.processConnect=function(_798,uri,_79a){
LOG.finest(_794,"connect",_798);
...
var _7a9=(function(){
var _7aa="WebSocketFlashEmulatedHandler";
var LOG=_26b.getLogger(_7aa);
var _7ac=function(){
var _7ad=new _75d();
return _7ad;
};
...
var _7b4=_7b0();
var _7b5=function(){
LOG.finest(_7aa,"<init>");
this.setNextHandler(_7b2);
_7b2.setNextHandler(_7b3);
_7b3.setNextHandler(_7b4);
};
var _7b6=_7b5.prototype=new _52d();
_7b6.processConnect=function(_7b7,_7b8,_7b9){
var _7ba=[_556.KAAZING_EXTENDED_HANDSHAKE];
for(var i=0;i<_7b9.length;i++){
_7ba.push(_7b9[i]);
}
var _7bc=_7b7._extensions;
if(_7bc.length>0){
_7b7.requestHeaders.push(new _4f1(_556.HEADER_SEC_EXTENSIONS,_7bc.join(";")));
}
this._nextHandler.processConnect(_7b7,_7b8,_7ba);
};
_7b6.setNextHandler=function(_7bd){
this._nextHandler=_7bd;
var _7be=new _540(this);
_7bd.setListener(_7be);
};
_7b6.setListener=function(_7bf){
this._listener=_7bf;
};
return _7b5;
})();
var _7c0=(function(){
var _7c1="WebSocketFlashRtmpDelegateHandler";
var LOG=_26b.getLogger(_7c1);
var _7c3;
var _7c4=function(){
LOG.finest(_7c1,"<init>");
_7c3=this;
};
var _7c5=_7c4.prototype=new _52d();
_7c5.processConnect=function(_7c6,uri,_7c8){
LOG.finest(_7c1,"connect",_7c6);
if(_7c6.readyState==2){
throw new Error("WebSocket is already closed");
}
var _7c9=new _339();
_7c9.parent=_7c6;
_7c6._delegate=_7c9;
_7ca(_7c9,this);
_7c9.connect(uri.toString(),_7c8);
};
_7c5.processTextMessage=function(_7cb,text){
LOG.finest(_7c1,"connect",_7cb);
if(_7cb.readyState==1){
_7cb._delegate.send(text);
}else{
throw new Error("WebSocket is already closed");
}
};
_7c5.processBinaryMessage=function(_7cd,_7ce){
LOG.finest(_7c1,"connect",_7cd);
if(_7cd.readyState==1){
_7cd._delegate.send(_7ce);
}else{
throw new Error("WebSocket is already closed");
}
};
_7c5.processClose=function(_7cf,code,_7d1){
LOG.finest(_7c1,"close",_7cf);
_7cf._delegate.close(code,_7d1);
};
var _7ca=function(_7d2,_7d3){
var _7d4=new _540(_7d3);
_7d4.redirected=function(_7d5,_7d6){
_7d5._redirectUri=_7d6;
};
_7d2.setListener(_7d4);
};
return _7c4;
})();
var _7d7=(function(){
var _7d8="WebSocketFlashRtmpHandler";
var LOG=_26b.getLogger(_7d8);
var _7da=function(){
var _7db=new _75d();
return _7db;
};
...
var _7e2=_7de();
var _7e3=function(){
LOG.finest(_7d8,"<init>");
this.setNextHandler(_7e0);
_7e0.setNextHandler(_7e1);
_7e1.setNextHandler(_7e2);
};
var _7e4=function(_7e5,_7e6){
LOG.finest(_7d8,"<init>");
};
var _7e7=_7e3.prototype=new _52d();
_7e7.setNextHandler=function(_7e8){
this._nextHandler=_7e8;
var _7e9=new _540(this);
_7e8.setListener(_7e9);
};
_7e7.setListener=function(_7ea){
this._listener=_7ea;
};
return _7e3;
})();
var _7eb=(function(){
var _7ec="WebSocketSelectedHandler";
var _LOG=_26b.getLogger(_7ec);
var _7ee=function(){
_LOG.fine(_7ec,"<init>");
};
var _7ef=_7ee.prototype=new _52d();
_7ef.processConnect=function(_7f0,uri,_7f2){
_LOG.fine(_7ec,"connect",_7f0);
if(_7f0.readyState==WebSocket.CLOSED){
throw new Error("WebSocket is already closed");
}
this._nextHandler.processConnect(_7f0,uri,_7f2);
};
_7ef.handleConnectionOpened=function(_7f3,_7f4){
_LOG.fine(_7ec,"handleConnectionOpened");
var _7f5=_7f3;
if(_7f5.readyState==WebSocket.CONNECTING){
_7f5.readyState=WebSocket.OPEN;
this._listener.connectionOpened(_7f3,_7f4);
}
};
_7ef.handleMessageReceived=function(_7f6,_7f7){
_LOG.fine(_7ec,"handleMessageReceived",_7f7);
if(_7f6.readyState!=WebSocket.OPEN){
return;
}
this._listener.textMessageReceived(_7f6,_7f7);
};
_7ef.handleBinaryMessageReceived=function(_7f8,_7f9){
_LOG.fine(_7ec,"handleBinaryMessageReceived",_7f9);
if(_7f8.readyState!=WebSocket.OPEN){
return;
}
this._listener.binaryMessageReceived(_7f8,_7f9);
};
_7ef.handleConnectionClosed=function(_7fa,_7fb,code,_7fd){
_LOG.fine(_7ec,"handleConnectionClosed");
var _7fe=_7fa;
if(_7fe.readyState!=WebSocket.CLOSED){
_7fe.readyState=WebSocket.CLOSED;
this._listener.connectionClosed(_7fa,_7fb,code,_7fd);
}
};
_7ef.handleConnectionFailed=function(_7ff){
_LOG.fine(_7ec,"connectionFailed");
if(_7ff.readyState!=WebSocket.CLOSED){
_7ff.readyState=WebSocket.CLOSED;
this._listener.connectionFailed(_7ff);
}
};
_7ef.handleConnectionError=function(_800,e){
_LOG.fine(_7ec,"connectionError");
this._listener.connectionError(_800,e);
};
_7ef.setNextHandler=function(_802){
this._nextHandler=_802;
var _803={};
var _804=this;
_803.connectionOpened=function(_805,_806){
_804.handleConnectionOpened(_805,_806);
};
_803.redirected=function(_807,_808){
throw new Error("invalid event received");
};
_803.authenticationRequested=function(_809,_80a,_80b){
throw new Error("invalid event received");
};
_803.textMessageReceived=function(_80c,buf){
_804.handleMessageReceived(_80c,buf);
};
_803.binaryMessageReceived=function(_80e,buf){
_804.handleBinaryMessageReceived(_80e,buf);
};
_803.connectionClosed=function(_810,_811,code,_813){
_804.handleConnectionClosed(_810,_811,code,_813);
};
_803.connectionFailed=function(_814){
_804.handleConnectionFailed(_814);
};
_803.connectionError=function(_815,e){
_804.handleConnectionError(_815,e);
};
_802.setListener(_803);
};
_7ef.setListener=function(_817){
this._listener=_817;
};
return _7ee;
})();
...
this._nativeEquivalent=_81a;
this._handler=_81b;
this._channelFactory=_81c;
};
return _819;
})();
var _81d=(function(){
var _81e="WebSocketCompositeHandler";
var _LOG=_26b.getLogger(_81e);
var _820="javascript:ws";
var _821="javascript:wss";
var _822="javascript:wse";
var _823="javascript:wse+ssl";
var _824="flash:wse";
var _825="flash:wse+ssl";
var _826="flash:wsr";
var _827="flash:wsr+ssl";
var _828={};
var _829={};
var _82a=new _565();
var _82b=new _55e();
...
try{
Object.defineProperty(_82d,"prop",{get:function(){
return true;
}});
_82c=false;
}
...
_LOG.finest(_81e,"<init>");
pickStrategies();
_828[_820]=new _818("ws",this._nativeHandler,_82a);
_828[_821]=new _818("wss",this._nativeHandler,_82a);
_828[_822]=new _818("ws",this._emulatedHandler,_82b);
_828[_823]=new _818("wss",this._emulatedHandler,_82b);
_828[_824]=new _818("ws",this._emulatedFlashHandler,_82b);
_828[_825]=new _818("wss",this._emulatedFlashHandler,_82b);
_828[_826]=new _818("ws",this._rtmpFlashHandler,_82b);
_828[_827]=new _818("wss",this._rtmpFlashHandler,_82b);
};
function isIE6orIE7(){
if(browser!="ie"){
return false;
...
return (_82f.indexOf("MSIE 6.0")>=0||_82f.indexOf("MSIE 7.0")>=0);
};
function isXdrDisabledonIE8IE9(){
if(browser!="ie"){
return false;
}
var _830=navigator.appVersion;
return ((_830.indexOf("MSIE 8.0")>=0||_830.indexOf("MSIE 9.0")>=0)&&typeof (XDomainRequest)==="undefined");
};
function pickStrategies(){
if(isIE6orIE7()||isXdrDisabledonIE8IE9()){
_829["ws"]=new Array(_820,_824,_822);
_829["wss"]=new Array(_821,_825,_823);
}else{
_829["ws"]=new Array(_820,_822);
_829["wss"]=new Array(_821,_823);
}
};
function createListener(_831){
var _832={};
_832.connectionOpened=function(_833,_834){
_831.handleConnectionOpened(_833,_834);
};
_832.binaryMessageReceived=function(_835,buf){
_831.handleMessageReceived(_835,buf);
};
_832.textMessageReceived=function(_837,text){
var _839=_837.parent;
_839._webSocketChannelListener.handleMessage(_839._webSocket,text);
};
_832.connectionClosed=function(_83a,_83b,code,_83d){
_831.handleConnectionClosed(_83a,_83b,code,_83d);
};
_832.connectionFailed=function(_83e){
_831.handleConnectionFailed(_83e);
};
_832.connectionError=function(_83f,e){
_831.handleConnectionError(_83f,e);
};
_832.authenticationRequested=function(_841,_842,_843){
};
_832.redirected=function(_844,_845){
};
_832.onBufferedAmountChange=function(_846,n){
_831.handleBufferedAmountChange(_846,n);
};
return _832;
};
function createNativeHandler(_848){
var _849=new _7eb();
var _84a=new _693();
_849.setListener(_848._handlerListener);
_849.setNextHandler(_84a);
return _849;
};
function createEmulatedHandler(_84b){
var _84c=new _7eb();
var _84d=new _77f();
_84c.setListener(_84b._handlerListener);
_84c.setNextHandler(_84d);
return _84c;
};
function createFlashEmulatedHandler(_84e){
var _84f=new _7eb();
var _850=new _7a9();
_84f.setListener(_84e._handlerListener);
_84f.setNextHandler(_850);
return _84f;
};
function createFlashRtmpHandler(_851){
var _852=new _7eb();
var _853=new _7d7();
...
var _857=_828[_856];
var _858=_857._channelFactory;
var _859=_855._location;
var _85a=_858.createChannel(_859,_855._protocol);
_855._selectedChannel=_85a;
_85a.parent=_855;
_85a._extensions=_855._extensions;
_85a._handler=_857._handler;
_85a._handler.processConnect(_855._selectedChannel,_859,_855._protocol);
};
var _85b=_82e.prototype;
_85b.fallbackNext=function(_85c){
_LOG.finest(_81e,"fallbackNext");
var _85d=_85c.getNextStrategy();
if(_85d==null){
this.doClose(_85c,false,1006,"");
}else{
_854(_85c,_85d);
}
};
_85b.doOpen=function(_85e,_85f){
if(_85e._lastErrorEvent!==undefined){
delete _85e._lastErrorEvent;
}
if(_85e.readyState===WebSocket.CONNECTING){
_85e.readyState=WebSocket.OPEN;
if(_82c){
_85e._webSocket.readyState=WebSocket.OPEN;
}
_85e._webSocketChannelListener.handleOpen(_85e._webSocket,_85f);
}
};
_85b.doClose=function(_860,_861,code,_863){
if(_860._lastErrorEvent!==undefined){
_860._webSocketChannelListener.handleError(_860._webSocket,_860._lastErrorEvent);
delete _860._lastErrorEvent;
}
if(_860.readyState===WebSocket.CONNECTING||_860.readyState===WebSocket.OPEN||_860.readyState===WebSocket.CLOSING){
_860.readyState=WebSocket.CLOSED;
if(_82c){
_860._webSocket.readyState=WebSocket.CLOSED;
}
_860._webSocketChannelListener.handleClose(_860._webSocket,_861,code,_863);
}
};
_85b.doBufferedAmountChange=function(_864,n){
_864._webSocketChannelListener.handleBufferdAmountChange(_864._webSocket,n);
};
_85b.processConnect=function(_866,_867,_868){
_LOG.finest(_81e,"connect",_866);
var _869=_866;
_LOG.finest("Current ready state = "+_869.readyState);
if(_869.readyState===WebSocket.OPEN){
...
var _86a=_869._compositeScheme;
if(_86a!="ws"&&_86a!="wss"){
var _86b=_828[_86a];
if(_86b==null){
throw new Error("Invalid connection scheme: "+_86a);
}
_LOG.finest("Turning off fallback since the URL is prefixed with java:");
_869._connectionStrategies.push(_86a);
}else{
var _86c=_829[_86a];
if(_86c!=null){
for(var i=0;i<_86c.length;i++){
_869._connectionStrategies.push(_86c[i]);
}
}else{
throw new Error("Invalid connection scheme: "+_86a);
}
...
_85b.processTextMessage=function(_86e,_86f){
_LOG.finest(_81e,"send",_86f);
var _870=_86e;
if(_870.readyState!=WebSocket.OPEN){
...
var _871=_870._selectedChannel;
_871._handler.processTextMessage(_871,_86f);
};
_85b.processBinaryMessage=function(_872,_873){
_LOG.finest(_81e,"send",_873);
var _874=_872;
...
_875._handler.processBinaryMessage(_875,_873);
};
_85b.processClose=function(_876,code,_878){
_LOG.finest(_81e,"close");
var _879=_876;
if(_876.readyState===WebSocket.CONNECTING||_876.readyState===WebSocket.OPEN){
_876.readyState=WebSocket.CLOSING;
if(_82c){
_876._webSocket.readyState=WebSocket.CLOSING;
}
}
var _87a=_879._selectedChannel;
_87a._handler.processClose(_87a,code,_878);
};
_85b.setListener=function(_87b){
this._listener=_87b;
};
_85b.handleConnectionOpened=function(_87c,_87d){
var _87e=_87c.parent;
this.doOpen(_87e,_87d);
};
_85b.handleMessageReceived=function(_87f,obj){
var _881=_87f.parent;
switch(_881.readyState){
case WebSocket.OPEN:
if(_881._webSocket.binaryType==="blob"&&obj.constructor==ByteBuffer){
obj=obj.getBlob(obj.remaining());
}else{
if(_881._webSocket.binaryType==="arraybuffer"&&obj.constructor==ByteBuffer){
obj=obj.getArrayBuffer(obj.remaining());
}else{
if(_881._webSocket.binaryType==="blob"&&obj.byteLength){
obj=new Blob([new Uint8Array(obj)]);
}else{
if(_881._webSocket.binaryType==="bytebuffer"&&obj.byteLength){
var u=new Uint8Array(obj);
var _883=[];
for(var i=0;i<u.byteLength;i++){
_883.push(u[i]);
}
obj=new ByteBuffer(_883);
}else{
if(_881._webSocket.binaryType==="bytebuffer"&&obj.size){
var cb=function(_886){
var b=new ByteBuffer();
b.putBytes(_886);
b.flip();
_881._webSocketChannelListener.handleMessage(_881._webSocket,b);
};
BlobUtils.asNumberArray(cb,data);
return;
}
...
_881._webSocketChannelListener.handleMessage(_881._webSocket,obj);
break;
...
_85b.handleConnectionClosed=function(_888,_889,code,_88b){
var _88c=_888.parent;
if(_88c.readyState===WebSocket.CONNECTING&&!_888.authenticationReceived&&!_888.preventFallback){
this.fallbackNext(_88c);
}else{
this.doClose(_88c,_889,code,_88b);
}
};
_85b.handleConnectionFailed=function(_88d){
var _88e=_88d.parent;
var _88f=1006;
var _890="";
if(_88d.closeReason.length>0){
_88f=_88d.closeCode;
_890=_88d.closeReason;
}
if(_88e.readyState===WebSocket.CONNECTING&&!_88d.authenticationReceived&&!_88d.preventFallback){
this.fallbackNext(_88e);
}else{
this.doClose(_88e,false,_88f,_890);
}
};
_85b.handleConnectionError=function(_891,e){
_891.parent._lastErrorEvent=e;
};
return _82e;
})();
(function(){
