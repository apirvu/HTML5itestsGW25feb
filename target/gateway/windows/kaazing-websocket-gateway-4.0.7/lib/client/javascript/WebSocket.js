...
var _716=_708.parent.parent._webSocket.connectTimeout;
if(_716==0){
_716=5000;
}
...
if(_70d.status==201){
var _717=_70d.responseText.split("\n");
var _718=_717[0];
var _719=_717[1];
var _71a=new URI(_70d.xhr._location);
var _71b=new URI(_718);
var _71c=new URI(_719);
if(_71a.host.toLowerCase()!=_71b.host.toLowerCase()){
throw new Error("Hostname in original URI does not match with the hostname in the upstream URI.");
}
if(_71a.host.toLowerCase()!=_71c.host.toLowerCase()){
throw new Error("Hostname in original URI does not match with the hostname in the downstream URI.");
}
_708._upstream=_71a.scheme+"://"+_71a.authority+_71b.path;
_708._downstream=new _69c(_719);
var _71d=_719.substring(0,_719.indexOf("/;e/"));
if(_71d!=_708.parent._location.toString().replace("ws","http")){
_708.parent._redirectUri=_71d;
}
_71e(_708,_708._downstream);
...
_720.readyState=1;
var _721=_720.parent;
_721._acceptedProtocol=_721.responseHeaders["X-WebSocket-Protocol"]||"";
if(_720.useXDR){
this.upstreamXHR=null;
openUpstream(_720);
}
_720._listener.connectionOpened(_720.parent,_721._acceptedProtocol);
};
function doError(_722){
if(_722.readyState<2){
_722.readyState=2;
if(_722.idleTimer){
...
if(_722.onerror!=null){
_722._listener.connectionFailed(_722.parent);
}
}
};
var _6fc=function(_723,_724,code,_726){
switch(_723.readyState){
case 2:
break;
case 0:
case 1:
_723.readyState=WebSocket.CLOSED;
if(_723.idleTimer){
clearTimeout(_723.idleTimer);
}
if(_723.upstreamXHR!=null){
_723.upstreamXHR.abort();
}
if(typeof _724==="undefined"){
_723._listener.connectionClosed(_723.parent,true,1005,"");
}else{
_723._listener.connectionClosed(_723.parent,_724,code,_726);
}
break;
default:
}
};
var _702=function(_727){
};
var _728=function(_729,_72a){
if(_72a.text){
_729._listener.textMessageReceived(_729.parent,_72a.text);
}else{
if(_72a.data){
_729._listener.binaryMessageReceived(_729.parent,_72a.data);
}
}
};
var _72b=function(_72c){
var _72d=ByteBuffer.allocate(2);
_72d.put(_6e9);
_72d.put(0);
_72d.flip();
doSend(_72c,_72d);
};
var _71e=function(_72e,_72f){
_72f.onmessage=function(_730){
switch(_730.type){
case "message":
if(_72e.readyState==1){
_728(_72e,_730);
}
break;
}
};
_72f.onping=function(){
if(_72e.readyState==1){
_72b(_72e);
}
};
_72f.onerror=function(){
try{
_72f.disconnect();
}
finally{
_6fc(_72e,true,_72e.closeCode,_72e.closeReason);
}
};
_72f.onclose=function(_731){
try{
_72f.disconnect();
}
finally{
_6fc(_72e,true,this.closeCode,this.closeReason);
}
};
};
return _6de;
...
var _734=_733.prototype=new _527();
_734.processConnect=function(_735,uri,_737){
if(_735.readyState==WebSocket.CLOSED){
throw new Error("WebSocket is already closed");
}
var _738=!!window.MockWseTransport?new MockWseTransport():new _6dd();
_738.parent=_735;
_735._delegate=_738;
_739(_738,this);
_738.connect(uri.toString(),_737);
};
_734.processTextMessage=function(_73a,text){
if(_73a.readyState==WebSocket.OPEN){
_73a._delegate.send(text);
}else{
throw new Error("WebSocket is already closed");
}
};
_734.processBinaryMessage=function(_73c,obj){
if(_73c.readyState==WebSocket.OPEN){
_73c._delegate.send(obj);
}else{
throw new Error("WebSocket is already closed");
}
};
_734.processClose=function(_73e,code,_740){
try{
_73e._delegate.close(code,_740);
}
catch(e){
listener.connectionClosed(_73e);
}
};
var _739=function(_741,_742){
var _743=new _53a(_742);
_741.setListener(_743);
};
return _733;
})();
var _744=(function(){
...
var _746=_745.prototype=new _527();
_746.handleClearAuthenticationData=function(_747){
if(_747._challengeResponse!=null){
_747._challengeResponse.clearCredentials();
}
};
_746.handleRemoveAuthenticationData=function(_748){
this.handleClearAuthenticationData(_748);
_748._challengeResponse=new ChallengeResponse(null,null);
};
_746.handle401=function(_749,_74a,_74b){
var _74c=this;
var _74d=null;
if(typeof (_749.parent.connectTimer)!="undefined"){
_74d=_749.parent.connectTimer;
if(_74d!=null){
_74d.pause();
}
}
if(_550.KAAZING_SEC_EXTENSION_REVALIDATE==_74b){
var _74e=new _5a7(_749);
_749.challengeHandler=_749.parent.challengeHandler;
_74e.connect(_74a);
}else{
var _74f=_74a;
if(_74f.indexOf("/;e/")>0){
_74f=_74f.substring(0,_74f.indexOf("/;e/"));
}
var _750=new _4f9(_74f.replace("http","ws"));
var _751=new ChallengeRequest(_74f,_74b);
var _752;
if(_749._challengeResponse.nextChallengeHandler!=null){
_752=_749._challengeResponse.nextChallengeHandler;
}else{
_752=_749.parent.challengeHandler;
}
if(_752!=null&&_752.canHandle(_751)){
_752.handle(_751,function(_753){
try{
if(_753==null||_753.credentials==null){
_74c.handleClearAuthenticationData(_749);
_74c._listener.connectionFailed(_749);
}else{
if(_74d!=null){
_74d.resume();
}
_749._challengeResponse=_753;
_74c.processConnect(_749,_750,_749._protocol);
}
}
catch(e){
_74c.handleClearAuthenticationData(_749);
...
this.handleClearAuthenticationData(_749);
this._listener.connectionFailed(_749);
}
}
};
_746.processConnect=function(_754,_755,_756){
if(_754._challengeResponse!=null&&_754._challengeResponse.credentials!=null){
var _757=_754._challengeResponse.credentials.toString();
for(var i=_754.requestHeaders.length-1;i>=0;i--){
if(_754.requestHeaders[i].label==="Authorization"){
_754.requestHeaders.splice(i,1);
}
}
var _759=new _4eb("Authorization",_757);
for(var i=_754.requestHeaders.length-1;i>=0;i--){
if(_754.requestHeaders[i].label==="Authorization"){
_754.requestHeaders.splice(i,1);
}
}
_754.requestHeaders.push(_759);
this.handleClearAuthenticationData(_754);
}
this._nextHandler.processConnect(_754,_755,_756);
};
_746.handleAuthenticate=function(_75a,_75b,_75c){
_75a.authenticationReceived=true;
this.handle401(_75a,_75b,_75c);
};
_746.setNextHandler=function(_75d){
this._nextHandler=_75d;
var _75e=new _53a(this);
var _75f=this;
_75e.authenticationRequested=function(_760,_761,_762){
_75f.handleAuthenticate(_760,_761,_762);
};
_75d.setListener(_75e);
};
_746.setListener=function(_763){
this._listener=_763;
};
return _745;
})();
...
var _767=new _732();
var _768=function(){
this.setNextHandler(_765);
_765.setNextHandler(_766);
_766.setNextHandler(_767);
};
var _769=_768.prototype=new _527();
_769.processConnect=function(_76a,_76b,_76c){
var _76d=[];
for(var i=0;i<_76c.length;i++){
_76d.push(_76c[i]);
}
var _76f=_76a._extensions;
if(_76f.length>0){
_76a.requestHeaders.push(new _4eb(_550.HEADER_SEC_EXTENSIONS,_76f.join(";")));
}
this._nextHandler.processConnect(_76a,_76b,_76d);
};
_769.setNextHandler=function(_770){
this._nextHandler=_770;
var _771=this;
var _772=new _53a(this);
_772.commandMessageReceived=function(_773,_774){
if(_774=="CloseCommandMessage"&&_773.readyState==1){
}
_771._listener.commandMessageReceived(_773,_774);
};
_770.setListener(_772);
};
_769.setListener=function(_775){
this._listener=_775;
};
return _768;
})();
...
var _778=_777.prototype=new _527();
_778.processConnect=function(_779,uri,_77b){
if(_779.readyState==2){
throw new Error("WebSocket is already closed");
}
var _77c=new _306();
_77c.parent=_779;
_779._delegate=_77c;
_77d(_77c,this);
_77c.connect(uri.toString(),_77b);
};
_778.processTextMessage=function(_77e,text){
if(_77e.readyState==1){
_77e._delegate.send(text);
}else{
throw new Error("WebSocket is already closed");
}
};
_778.processBinaryMessage=function(_780,_781){
if(_780.readyState==1){
_780._delegate.send(_781);
}else{
throw new Error("WebSocket is already closed");
}
};
_778.processClose=function(_782,code,_784){
_782._delegate.close(code,_784);
};
var _77d=function(_785,_786){
var _787=new _53a(_786);
_785.setListener(_787);
_787.redirected=function(_788,_789){
_788._redirectUri=_789;
};
};
return _777;
})();
...
var _793=_78f();
var _794=function(){
this.setNextHandler(_791);
_791.setNextHandler(_792);
_792.setNextHandler(_793);
};
var _795=_794.prototype=new _527();
_795.processConnect=function(_796,_797,_798){
var _799=[_550.KAAZING_EXTENDED_HANDSHAKE];
for(var i=0;i<_798.length;i++){
_799.push(_798[i]);
}
var _79b=_796._extensions;
if(_79b.length>0){
_796.requestHeaders.push(new _4eb(_550.HEADER_SEC_EXTENSIONS,_79b.join(";")));
}
this._nextHandler.processConnect(_796,_797,_799);
};
_795.setNextHandler=function(_79c){
this._nextHandler=_79c;
var _79d=new _53a(this);
_79c.setListener(_79d);
};
_795.setListener=function(_79e){
this._listener=_79e;
};
return _794;
})();
...
var _7a2=_7a1.prototype=new _527();
_7a2.processConnect=function(_7a3,uri,_7a5){
if(_7a3.readyState==2){
throw new Error("WebSocket is already closed");
}
var _7a6=new _336();
_7a6.parent=_7a3;
_7a3._delegate=_7a6;
_7a7(_7a6,this);
_7a6.connect(uri.toString(),_7a5);
};
_7a2.processTextMessage=function(_7a8,text){
if(_7a8.readyState==1){
_7a8._delegate.send(text);
}else{
throw new Error("WebSocket is already closed");
}
};
_7a2.processBinaryMessage=function(_7aa,_7ab){
if(_7aa.readyState==1){
_7aa._delegate.send(_7ab);
}else{
throw new Error("WebSocket is already closed");
}
};
_7a2.processClose=function(_7ac,code,_7ae){
_7ac._delegate.close(code,_7ae);
};
var _7a7=function(_7af,_7b0){
var _7b1=new _53a(_7b0);
_7b1.redirected=function(_7b2,_7b3){
_7b2._redirectUri=_7b3;
};
_7af.setListener(_7b1);
};
return _7a1;
})();
var _7b4=(function(){
...
var _7bf=function(_7c0,_7c1){
};
var _7c2=_7be.prototype=new _527();
_7c2.setNextHandler=function(_7c3){
this._nextHandler=_7c3;
var _7c4=new _53a(this);
_7c3.setListener(_7c4);
};
_7c2.setListener=function(_7c5){
this._listener=_7c5;
};
return _7be;
})();
...
var _7c8=_7c7.prototype=new _527();
_7c8.processConnect=function(_7c9,uri,_7cb){
if(_7c9.readyState==WebSocket.CLOSED){
throw new Error("WebSocket is already closed");
}
this._nextHandler.processConnect(_7c9,uri,_7cb);
};
_7c8.handleConnectionOpened=function(_7cc,_7cd){
var _7ce=_7cc;
if(_7ce.readyState==WebSocket.CONNECTING){
_7ce.readyState=WebSocket.OPEN;
this._listener.connectionOpened(_7cc,_7cd);
}
};
_7c8.handleMessageReceived=function(_7cf,_7d0){
if(_7cf.readyState!=WebSocket.OPEN){
return;
}
this._listener.textMessageReceived(_7cf,_7d0);
};
_7c8.handleBinaryMessageReceived=function(_7d1,_7d2){
if(_7d1.readyState!=WebSocket.OPEN){
return;
}
this._listener.binaryMessageReceived(_7d1,_7d2);
};
_7c8.handleConnectionClosed=function(_7d3,_7d4,code,_7d6){
var _7d7=_7d3;
if(_7d7.readyState!=WebSocket.CLOSED){
_7d7.readyState=WebSocket.CLOSED;
this._listener.connectionClosed(_7d3,_7d4,code,_7d6);
}
};
_7c8.handleConnectionFailed=function(_7d8){
if(_7d8.readyState!=WebSocket.CLOSED){
_7d8.readyState=WebSocket.CLOSED;
this._listener.connectionFailed(_7d8);
}
};
_7c8.handleConnectionError=function(_7d9,e){
this._listener.connectionError(_7d9,e);
};
_7c8.setNextHandler=function(_7db){
this._nextHandler=_7db;
var _7dc={};
var _7dd=this;
_7dc.connectionOpened=function(_7de,_7df){
_7dd.handleConnectionOpened(_7de,_7df);
};
_7dc.redirected=function(_7e0,_7e1){
throw new Error("invalid event received");
};
_7dc.authenticationRequested=function(_7e2,_7e3,_7e4){
throw new Error("invalid event received");
};
_7dc.textMessageReceived=function(_7e5,buf){
_7dd.handleMessageReceived(_7e5,buf);
};
_7dc.binaryMessageReceived=function(_7e7,buf){
_7dd.handleBinaryMessageReceived(_7e7,buf);
};
_7dc.connectionClosed=function(_7e9,_7ea,code,_7ec){
_7dd.handleConnectionClosed(_7e9,_7ea,code,_7ec);
};
_7dc.connectionFailed=function(_7ed){
_7dd.handleConnectionFailed(_7ed);
};
_7dc.connectionError=function(_7ee,e){
_7dd.handleConnectionError(_7ee,e);
};
_7db.setListener(_7dc);
};
_7c8.setListener=function(_7f0){
this._listener=_7f0;
};
return _7c7;
})();
...
this._nativeEquivalent=_7f3;
this._handler=_7f4;
this._channelFactory=_7f5;
};
return _7f2;
})();
var _7f6=(function(){
var _7f7="javascript:ws";
var _7f8="javascript:wss";
var _7f9="javascript:wse";
var _7fa="javascript:wse+ssl";
var _7fb="flash:wse";
var _7fc="flash:wse+ssl";
var _7fd="flash:wsr";
var _7fe="flash:wsr+ssl";
var _7ff={};
var _800={};
var _801=new _55f();
var _802=new _558();
...
try{
Object.defineProperty(_804,"prop",{get:function(){
return true;
}});
_803=false;
}
...
pickStrategies();
_7ff[_7f7]=new _7f1("ws",this._nativeHandler,_801);
_7ff[_7f8]=new _7f1("wss",this._nativeHandler,_801);
_7ff[_7f9]=new _7f1("ws",this._emulatedHandler,_802);
_7ff[_7fa]=new _7f1("wss",this._emulatedHandler,_802);
_7ff[_7fb]=new _7f1("ws",this._emulatedFlashHandler,_802);
_7ff[_7fc]=new _7f1("wss",this._emulatedFlashHandler,_802);
_7ff[_7fd]=new _7f1("ws",this._rtmpFlashHandler,_802);
_7ff[_7fe]=new _7f1("wss",this._rtmpFlashHandler,_802);
};
function isIE6orIE7(){
if(browser!="ie"){
return false;
...
return (_806.indexOf("MSIE 6.0")>=0||_806.indexOf("MSIE 7.0")>=0);
};
function isXdrDisabledonIE8IE9(){
if(browser!="ie"){
return false;
}
var _807=navigator.appVersion;
return ((_807.indexOf("MSIE 8.0")>=0||_807.indexOf("MSIE 9.0")>=0)&&typeof (XDomainRequest)==="undefined");
};
function pickStrategies(){
if(isIE6orIE7()||isXdrDisabledonIE8IE9()){
_800["ws"]=new Array(_7f7,_7fb,_7f9);
_800["wss"]=new Array(_7f8,_7fc,_7fa);
}else{
_800["ws"]=new Array(_7f7,_7f9);
_800["wss"]=new Array(_7f8,_7fa);
}
};
function createListener(_808){
var _809={};
_809.connectionOpened=function(_80a,_80b){
_808.handleConnectionOpened(_80a,_80b);
};
_809.binaryMessageReceived=function(_80c,buf){
_808.handleMessageReceived(_80c,buf);
};
_809.textMessageReceived=function(_80e,text){
var _810=_80e.parent;
_810._webSocketChannelListener.handleMessage(_810._webSocket,text);
};
_809.connectionClosed=function(_811,_812,code,_814){
_808.handleConnectionClosed(_811,_812,code,_814);
};
_809.connectionFailed=function(_815){
_808.handleConnectionFailed(_815);
};
_809.connectionError=function(_816,e){
_808.handleConnectionError(_816,e);
};
_809.authenticationRequested=function(_818,_819,_81a){
};
_809.redirected=function(_81b,_81c){
};
_809.onBufferedAmountChange=function(_81d,n){
_808.handleBufferedAmountChange(_81d,n);
};
return _809;
};
function createNativeHandler(_81f){
var _820=new _7c6();
var _821=new _680();
_820.setListener(_81f._handlerListener);
_820.setNextHandler(_821);
return _820;
};
function createEmulatedHandler(_822){
var _823=new _7c6();
var _824=new _764();
_823.setListener(_822._handlerListener);
_823.setNextHandler(_824);
return _823;
};
function createFlashEmulatedHandler(_825){
var _826=new _7c6();
var _827=new _78a();
_826.setListener(_825._handlerListener);
_826.setNextHandler(_827);
return _826;
};
function createFlashRtmpHandler(_828){
var _829=new _7c6();
var _82a=new _7b4();
...
var _82b=function(_82c,_82d){
var _82e=_7ff[_82d];
var _82f=_82e._channelFactory;
var _830=_82c._location;
var _831=_82f.createChannel(_830,_82c._protocol);
_82c._selectedChannel=_831;
_831.parent=_82c;
_831._extensions=_82c._extensions;
_831._handler=_82e._handler;
_831._handler.processConnect(_82c._selectedChannel,_830,_82c._protocol);
};
var _832=_805.prototype;
_832.fallbackNext=function(_833){
var _834=_833.getNextStrategy();
if(_834==null){
this.doClose(_833,false,1006,"");
}else{
_82b(_833,_834);
}
};
_832.doOpen=function(_835,_836){
if(_835._lastErrorEvent!==undefined){
delete _835._lastErrorEvent;
}
if(_835.readyState===WebSocket.CONNECTING){
_835.readyState=WebSocket.OPEN;
if(_803){
_835._webSocket.readyState=WebSocket.OPEN;
}
_835._webSocketChannelListener.handleOpen(_835._webSocket,_836);
}
};
_832.doClose=function(_837,_838,code,_83a){
if(_837._lastErrorEvent!==undefined){
_837._webSocketChannelListener.handleError(_837._webSocket,_837._lastErrorEvent);
delete _837._lastErrorEvent;
}
if(_837.readyState===WebSocket.CONNECTING||_837.readyState===WebSocket.OPEN||_837.readyState===WebSocket.CLOSING){
_837.readyState=WebSocket.CLOSED;
if(_803){
_837._webSocket.readyState=WebSocket.CLOSED;
}
_837._webSocketChannelListener.handleClose(_837._webSocket,_838,code,_83a);
}
};
_832.doBufferedAmountChange=function(_83b,n){
_83b._webSocketChannelListener.handleBufferdAmountChange(_83b._webSocket,n);
};
_832.processConnect=function(_83d,_83e,_83f){
var _840=_83d;
if(_840.readyState===WebSocket.OPEN){
throw new Error("Attempt to reconnect an existing open WebSocket to a different location");
}
var _841=_840._compositeScheme;
if(_841!="ws"&&_841!="wss"){
var _842=_7ff[_841];
if(_842==null){
throw new Error("Invalid connection scheme: "+_841);
}
_840._connectionStrategies.push(_841);
}else{
var _843=_800[_841];
if(_843!=null){
for(var i=0;i<_843.length;i++){
_840._connectionStrategies.push(_843[i]);
}
}else{
throw new Error("Invalid connection scheme: "+_841);
}
}
this.fallbackNext(_840);
};
_832.processTextMessage=function(_845,_846){
var _847=_845;
if(_847.readyState!=WebSocket.OPEN){
throw new Error("Attempt to post message on unopened or closed web socket");
}
var _848=_847._selectedChannel;
_848._handler.processTextMessage(_848,_846);
};
_832.processBinaryMessage=function(_849,_84a){
var _84b=_849;
if(_84b.readyState!=WebSocket.OPEN){
throw new Error("Attempt to post message on unopened or closed web socket");
}
var _84c=_84b._selectedChannel;
_84c._handler.processBinaryMessage(_84c,_84a);
};
_832.processClose=function(_84d,code,_84f){
var _850=_84d;
if(_84d.readyState===WebSocket.CONNECTING||_84d.readyState===WebSocket.OPEN){
_84d.readyState=WebSocket.CLOSING;
if(_803){
_84d._webSocket.readyState=WebSocket.CLOSING;
}
}
var _851=_850._selectedChannel;
_851._handler.processClose(_851,code,_84f);
};
_832.setListener=function(_852){
this._listener=_852;
};
_832.handleConnectionOpened=function(_853,_854){
var _855=_853.parent;
this.doOpen(_855,_854);
};
_832.handleMessageReceived=function(_856,obj){
var _858=_856.parent;
switch(_858.readyState){
case WebSocket.OPEN:
if(_858._webSocket.binaryType==="blob"&&obj.constructor==ByteBuffer){
obj=obj.getBlob(obj.remaining());
}else{
if(_858._webSocket.binaryType==="arraybuffer"&&obj.constructor==ByteBuffer){
obj=obj.getArrayBuffer(obj.remaining());
}else{
if(_858._webSocket.binaryType==="blob"&&obj.byteLength){
obj=new Blob([new Uint8Array(obj)]);
}else{
if(_858._webSocket.binaryType==="bytebuffer"&&obj.byteLength){
var u=new Uint8Array(obj);
var _85a=[];
for(var i=0;i<u.byteLength;i++){
_85a.push(u[i]);
}
obj=new ByteBuffer(_85a);
}else{
if(_858._webSocket.binaryType==="bytebuffer"&&obj.size){
var cb=function(_85d){
var b=new ByteBuffer();
b.putBytes(_85d);
b.flip();
_858._webSocketChannelListener.handleMessage(_858._webSocket,b);
};
BlobUtils.asNumberArray(cb,data);
return;
}
...
_858._webSocketChannelListener.handleMessage(_858._webSocket,obj);
break;
...
_832.handleConnectionClosed=function(_85f,_860,code,_862){
var _863=_85f.parent;
if(_863.readyState===WebSocket.CONNECTING&&!_85f.authenticationReceived&&!_85f.preventFallback){
this.fallbackNext(_863);
}else{
this.doClose(_863,_860,code,_862);
}
};
_832.handleConnectionFailed=function(_864){
var _865=_864.parent;
var _866=1006;
var _867="";
if(_864.closeReason.length>0){
_866=_864.closeCode;
_867=_864.closeReason;
}
if(_865.readyState===WebSocket.CONNECTING&&!_864.authenticationReceived&&!_864.preventFallback){
this.fallbackNext(_865);
}else{
this.doClose(_865,false,_866,_867);
}
};
_832.handleConnectionError=function(_868,e){
_868.parent._lastErrorEvent=e;
};
return _805;
})();
(function(){
